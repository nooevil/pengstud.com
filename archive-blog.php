    ...
    <div class="blog-archive-v3__content__sidebar">
      ...
      <div class="blog-archive-v3__content__main-wrap">
        <?php  if( !get_query_var('paged') ) :  ?>
          <!-- Отображается на первой странице каталога -->
          <div class="blog-archive-v3__content__new-articles">
          <?php 
            $countArticle = 1;
            while ( have_posts() and $countArticle <= 1) : 
            the_post();  
          ?>
              <div class="blog-archive-v3__content__new-articles__large">
                
                <div class="blog-archive-v3__content__new-articles__large__img-container">
                  <?php
                    $article_level = get_post_meta($post->ID, "complexity_post", true);
                    if ($article_level == '1') : ?>
                      <img 
                        class="blog-archive-v3__content__new-articles__large__img-container__level" 
                  ...
                  <?php echo wp_get_attachment_image( get_post_meta( $post->ID, "preview_image", true)); ?>
                ...
                <h2 class="blog-archive-v3__content__new-articles__large__title">
                ...
                <?php
                  ...
                  if ($short_description !== '') : ?>
                    <p class="blog-archive-v3__content__new-articles__large__description">
                      <?php echo $short_description; ?>
                    </p>
                <?php endif; ?>

                <div class="blog-archive-v3__content__new-articles__large__info">
                    <div class="blog-archive-v3__content__new-articles__large__info__left">
                      <?php
                        $article_author = get_post_meta($post->ID, "author_post", true)[0];
                        if ($article_author !== '') : ?>
                          <p class="blog-archive-v3__content__new-articles__large__info__left__author">
                            <?php echo $article_author; ?>
                          </p>
                      <?php endif; ?>

                      <p class="blog-archive-v3__content__new-articles__large__info__left__date">
                        <?php the_time('j.m.Y') ?>
                      </p>
                    </div>
                    <div class="blog-archive-v3__content__new-articles__large__info__right">

                      <p class="blog-archive-v3__content__new-articles__large__info__right__views">
                        <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M10 12.6364C6.02097 12.6364 2.59893 10.2463 
                          1.08357 6.81818C2.59893 3.39005 6.02097 1 10 1C13.979 1 17.4011 3.39005 18.9164 6.81818C17.4011 
                          10.2463 13.979 12.6364 10 12.6364ZM10 13.6364C14.5455 13.6364 18.4273 10.8091 20 6.81818C18.4273 
                      ...
                      <p class="blog-archive-v3__content__new-articles__large__info__right__likes">
                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M7.61932 1.99617L8 2.4432L8.38068 1.99617C9.16088 1.07997 10.3594 0.5 11.6 0.5C13.7879 
                          0.5 15.5 2.21214 15.5 4.4C15.5 5.74776 14.8984 7.00974 13.738 8.42844C12.5718 9.85416 10.8942 
                          11.3765 8.82413 13.2536L8.82341 13.2543L7.99872 14.005L7.17626 13.262L7.17519 13.261L7.17159 
                      ...
                      <?php
                        $article_time = get_post_meta($post->ID, "read_time", true);
                        if ($article_time !== '') : ?>
                          <p class="blog-archive-v3__content__new-articles__large__info__right__time">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M15 8C15 11.866 11.866 15 8 15C4.13401 15 1 
                              11.866 1 8C1 4.13401 4.13401 1 8 1C11.866 1 15 4.13401 15 8ZM16 8C16 12.4183 12.4183 16 8 
                              16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8ZM8.5 
          ...
          <div class="blog-archive-v3__content__new-articles__small">
            <?php 
              $countSmallArticle = 1;
              while ( have_posts() and $countSmallArticle <= 2) : 
              the_post();  
            ?>
                  <div class="blog-archive-v3__content__new-articles__small__item">
                    <div class="blog-archive-v3__content__new-articles__small__item__head">

                      <div class="blog-archive-v3__content__new-articles__small__item__head__text">
                        <?php
                          $article_author = get_post_meta($post->ID, "author_post", true)[0];
                          if ($article_author !== '') : ?>
                            <p class="blog-archive-v3__content__new-articles__small__item__head__text__author">
                              <?php echo $article_author; ?>
                            </p>
                        <?php endif; ?>

                        <p class="blog-archive-v3__content__new-articles__small__item__head__text__date">
                          <?php the_time('j.m.Y') ?>
                        </p>
                      </div>

                      <div class="blog-archive-v3__content__new-articles__small__item__head__icons">
                        <?php
                          $article_level = get_post_meta($post->ID, "complexity_post", true);
                          if ($article_level == '1') : ?>
                            <img 
                              class="blog-archive-v3__content__new-articles__small__item__head__icons__level" 
                          ...
                          <img 
                            data-href="<?php the_permalink(); ?>"
                            class="blog-archive-v3__content__main-wrap__articles__item__img-wrap__share" 
                            src="<?php echo REL_ASSETS_URI ?>img/blog/share icon dark.svg">
                      </div>
                    </div>
                    <div class="blog-archive-v3__content__new-articles__small__item__title">
                      <a href="<?php the_permalink(); ?>" target="_blank"><?php the_title(); ?></a>
                    </div>
                    <div class="blog-archive-v3__content__new-articles__small__item__info">
                      <p class="blog-archive-v3__content__new-articles__small__item__info__text">
                        <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M10 12.6364C6.02097 12.6364 2.59893 10.2463 
                          1.08357 6.81818C2.59893 3.39005 6.02097 1 10 1C13.979 1 17.4011 3.39005 18.9164 6.81818C17.4011 
                          10.2463 13.979 12.6364 10 12.6364ZM10 13.6364C14.5455 13.6364 18.4273 10.8091 20 6.81818C18.4273 
          ...
          <!-- compilation -->
          <div class="blog-archive-v3__content__compilation">
            <h3 class="blog-archive-v3__content__compilation__title">Как рекламировать eCommerce</h3>
            <div class="blog-archive-v3__content__compilation__separator"></div>
            <div class="blog-archive-v3__content__compilation__slide">
            <?php
                  $args_loop = array(
                      'post_type'  => 'blog',
                      'order'      => 'DESC',
                  ...
                  while ( $custom_loop->have_posts() ) : $custom_loop->the_post(); ?>
                    <a class="blog-archive-v3__content__compilation__slide__article">
                      <div class="blog-archive-v3__content__compilation__slide__article__img-wrap">
                      <?php echo wp_get_attachment_image( get_post_meta( $post->ID, "preview_image", true), '300_300'); ?>
                      </div>
                      <h4 class="blog-archive-v3__content__compilation__slide__article__title">
                        <?php the_title(); ?>
                      </h4>
                    </a>
          ...
          <!-- articles row 4-6 -->
          <div class="blog-archive-v3__content__articles-row">
          <?php 
              $count = 1;
              while ( have_posts() and $count <= 6) : 
              the_post(); 
              if ($count > 3) :
            ?>
          ...
          <!-- compilation -->
          <div class="blog-archive-v3__content__compilation">
            <h3 class="blog-archive-v3__content__compilation__title">Бесплатные гайды Penguin-team по возможностям Google помогут</h3>
            <div class="blog-archive-v3__content__compilation__separator"></div>
            <div class="blog-archive-v3__content__compilation__slide">
            <?php
                  $args_loop = array(
          ...
          <!-- compilation -->
          <div class="blog-archive-v3__content__compilation">
            <h3 class="blog-archive-v3__content__compilation__title">Для тех, кто хочет знать больше</h3>
            <div class="blog-archive-v3__content__compilation__separator"></div>
            <div class="blog-archive-v3__content__compilation__slide">
            <?php
                  $args_loop = array(
        ...
        <?php else : ?>
        <!-- Отображается на страницах каталога 2 и больше -->
...
<script>
	$(function() {
		$(document).ready(function(){
		  	$('.blog-archive-v3__content__compilation__slide').slick({
          centerPadding: '10px',
          slidesToShow: 4,
          slidesToScroll: 2,
          prevArrow: `<button class="slider_arrow_prev">
...
<?php else : ?>
  ...
  <div class="blog_archive_v2">
    <div class="wrapper_m container">
      ...
      <!-- blog_archive_v2__content_holder -->
                ...
                <div class="col-md-8 p-0">
                  <div class="article_item__content">
                    ...
                    <div class="article_item__footer">
                      <a href="<?php the_permalink(); ?>" target="_blank" class="article_more_btn"><?php _e('подробнее'); ?></a>
                    </div>
          ...
          <div class="col-lg-3 col-md-12">
            <div class="blog_archive_v2__sidebar_holder">
              ...
              <div class="blog_archive_v2__sidebar_tags">
                ...
                ?>
                  <a href="<?php echo $value['link']; ?>" class="item_tags"><?php echo $value['name']; ?></a>
                <?php
                  endforeach;
                ?>
              </div>
